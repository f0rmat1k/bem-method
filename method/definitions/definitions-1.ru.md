...
```
* Блок + элемент другого блока<br>
```html
<div class="link menu__link">...</div>
```
* Блок + элемент этого же блока<br>
```html
<div class="menu menu__layout">...</div>
```
* Элемент одного блока + элемент другого блока<br>
```html
<div class="menu__item head-menu__item">...</div>
```
* Блок с модификатором + другой блок<br>
```html
<div class="menu menu_layout_horiz head-menu">...</div>
```
* Блок/элемент с модификатором + другой блок/элемент с модификатором<br>
```html

...
БЭМ-дерево — это представление структуры веб-страницы в терминах блоков, элементов, модификаторов и их данных. Оно описывает имена БЭМ-сущностей, их состояния, порядок и вложенность, и вспомогательные данные.

БЭМ-дерево дает возможность взаимодействовать со структурой веб-страницы в терминах БЭМ, абстрагируясь от привычной DOM-реализации.
...
* `touch.blocks` — функции, характерные для touch-устройств (например, `swype` и специфические CSS-правила).

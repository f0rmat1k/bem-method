...
БЭМ-дерево — это абстракция над DOM-деревом. представление структуры веб-страницы в терминах блоков, элементов, модификаторов и их данных. Оно описывает имена БЭМ-сущностей, их состояния, порядок и вложенность, и вспомогательные данные.?????????
